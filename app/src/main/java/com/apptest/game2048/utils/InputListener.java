...
import com.apptest.game2048.activities.GameBoardActivity;
import com.apptest.game2048.R;


import static com.apptest.game2048.activities.GameBoardActivity.mInterstitialAd;
import static com.apptest.game2048.activities.GameBoardActivity.rewardedVideoAd;
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (!hasMoved) {
                    if (iconPressed(mView.sXNewGame, mView.sYIcons)) {
                        ...
                        GameBoardActivity.running = false;
                        if (!mView.game.gameLost()) {
                            new AlertDialog.Builder(mView.getContext())
                                    .setPositiveButton(R.string.reset, new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            //InterstiatialAd Show
                                            if (mInterstitialAd.isLoaded()) {
                                                mInterstitialAd.show();
                                                mView.game.newGame(false);
                                            } else {
                                                mView.game.newGame(false);
                                            }
                                        }
                                    ...
                                    .setNegativeButton(R.string.continue_game, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            GameBoardActivity.running = true;
                                        }
                                    })
...
//                        mView.game.revertUndoState();
                        ...
                        new AlertDialog.Builder(mView.getContext())
                                .setPositiveButton(R.string.undo, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if (rewardedVideoAd.isLoaded()) {
                                            ...
                                            GameBoardActivity.loadRewardedVideoAd();
                                            rewardedVideoAd.show();
                                        }
                                    }
                                })
                                ...
                                .setTitle(R.string.undo_dialog_title)
                                .setMessage(R.string.undo_dialog_message)
                                .show();
