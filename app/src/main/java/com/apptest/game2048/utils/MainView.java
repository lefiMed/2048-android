...
import com.apptest.game2048.models.AnimationCell;
...
public class MainView extends View {
    ...
    private void drawNewGameButton(Canvas canvas, boolean lightUp) {
        ...
        drawDrawable(canvas,
                getResources().getDrawable(R.mipmap.ic_refresh_white_48dp),
    ...
    private void drawUndoButton(Canvas canvas, boolean lightUp) {
        ...
        drawDrawable(canvas,
                getResources().getDrawable(R.mipmap.ic_undo_white_48dp),
    ...
    private void drawPauseButton(Canvas canvas, boolean play) {
        ...
        if (play) {
            ...
            drawDrawable(canvas,
                    getResources().getDrawable(R.mipmap.ic_play_arrow_white_48dp),
            ...
            drawDrawable(canvas,
                    getResources().getDrawable(R.mipmap.ic_pause),
                    sXPause + iconPaddingSize,
                    sYIcons + iconPaddingSize,
                    sXPause + iconSize - iconPaddingSize,
                    sYIcons + iconSize - iconPaddingSize
